# From the Transformer-XL code found at https://github.com/kimiyoung/transformer-xl
...
from transformer_xl.tf.vocabulary import Vocab, create_vocab_trie
...
class Corpus(object):
    def __init__(self, path, dataset, vocab_size=None, *args, **kwargs):
        ...
        self.vocab.vocab_trie = create_vocab_trie(self.dataset, self.vocab.sym2idx, vocab_size)
...
def get_lm_corpus(data_dir, dataset, vocab_size=None):
    ...
    if exists(fn):
        ...
        if not hasattr(corpus.vocab, 'vocab_trie'):
            corpus.vocab.vocab_trie = create_vocab_trie(dataset, corpus.vocab.sym2idx, vocab_size)
        ...
        corpus = Corpus(data_dir, dataset, vocab_size, **kwargs)
