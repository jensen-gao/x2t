            ...
            for i in range(len(cutoff_ends) - 1):
                with tf.variable_scope('cutoff_{}'.format(i)):
                    ...
                    if i == 0:
                        ...
                        cluster_logprob = cur_head_logprob[:, cutoff_ends[1] + i - 1]
                        cur_logprob = (cluster_logprob + _gather_logprob(tail_logprob, cur_target))
...
def cache_mem(curr_out, prev_mem, mem_len=None):
